...
|---|---|---|---|---|
| Live vessel positions | AISStream or another permitted AIS provider | Selected regional vessel observations | API terms, coverage, historical retention | **TBD** |
...
Code license and data licenses are separate. Before adding each source,
